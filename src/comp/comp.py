...
c = [person.name for person in humans if person.name[0] in C_G]
print(c)

# Write a list comprehension that creates a list of all the ages plus 10.
print("Ages plus 10:")
d = [(person.name, person.age + 10)for person in humans if person.age]
print(d)
...
import math
h = [math.sqrt(person.age) for person in humans if person.age]
print(h)
